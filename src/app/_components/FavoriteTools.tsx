        ...
        <div className={'min-h-96 my-20 w-full p-8'}>
            <div className={'size-full'}>
                <div className={'text-center grid gap-8 my-4 place-items-center'}>
                    <h3 className={'size-fit text-xl bg-pink-100 px-4 rounded-full p-2'}>My favorite tools 🛠️</h3>
                    <h1 className={'text-3xl'}>These are the tools I use everyday</h1>
                </div>
                <div className={'w-full flex flex-wrap'}>
                    {
                        tools.map((item,i) => (
                            <Link key={i} className={'w-full xl:w-1/3 flex gap-4 hover:bg-pink-50 duration-1000 rounded-3xl min-h-32 p-8'} href={''}>
                                <div className={'size-20 grid bg-pink-50 rounded-3xl place-items-center'}>
