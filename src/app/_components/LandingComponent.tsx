...
const LandingComponent = () => {
    ...
    return (
        <div
            className={'size-full min-h-96 bg-pink-50 pb-20 mt-20 md:rounded-t-[118px] flex flex-col justify-center items-center p-2 md:px-16 xl:px-32 text-7xl'}>
            ...
            <div className={'w-full mt-36 min-h-96'}>
                {Projects.map((item, i) => (
                    <div key={i} className={`bg-white ${item.bg} sticky top-24 min-h-96 rounded-[48px] flex flex-col md:flex-row items-center py-32 gap-8 p-2 md:p-16 justify-center size-full`}>
