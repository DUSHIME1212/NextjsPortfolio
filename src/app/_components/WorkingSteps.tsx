        ...
        <div className={'min-h-96 my-20 w-full p-8'}>
            <div className={'size-full'}>
                <div className={'text-center grid gap-8 my-4 place-items-center'}>
                    <h3 className={'size-fit text-xl bg-pink-100 px-4 rounded-full p-2'}>Ways of working 💡</h3>
                ...
                <div className={'w-full flex gap-2 justify-evenly flex-wrap'}>
                    {
                        works.map((item, i) => (
                            <Link key={i}
                                  className={'w-full md:w-[48%] flex gap-4 hover:bg-pink-50 duration-1000 rounded-3xl min-h-fit p-8'}
                                  href={''}>
