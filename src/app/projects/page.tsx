      ...
      <div className="flex min-h-screen flex-col items-center justify-start gap-4">
        ...
        >
          ...
          {Projects.map((item, i) => (
            <div
              key={i}
              className={`bg-white ${item.bg} flex size-full min-h-96 flex-col items-center justify-center gap-8 rounded-[48px] px-4 py-16 shadow-md md:flex-row md:px-16 md:py-32`}
            >
